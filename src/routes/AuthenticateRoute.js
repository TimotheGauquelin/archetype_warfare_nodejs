...
router.post('/login', loginLimiter, (request, result, next) => AuthenticateController.login(request, result, next));
...
router.post('/register', usernameRuler, passwordRuler, registerLimiter, (request, result, next) => AuthenticateController.register(request, result, next));
